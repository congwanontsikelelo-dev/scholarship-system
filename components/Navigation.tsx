...
import { GraduationCap, Menu, X, Bell, User, Home, BookOpen, Briefcase, ClipboardList, Calendar, FileText, CreditCard, Users } from "lucide-react"
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 w-full">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Link href="/dashboard/payment-plans">
              <Button variant="ghost">
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 space-y-2">
            ...
            <Link href="/dashboard/work-study" className="block">
              <Button variant="ghost" className="w-full justify-start">
                Work-Study
              </Button>
            </Link>
            ...
            <Link href="/dashboard/payment-plans" className="block">
              <Button variant="ghost" className="w-full justify-start">
                Payments
              </Button>
            </Link>
